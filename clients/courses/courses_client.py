...
from clients.courses.courses_schema import CreateCourseRequestSchema, GetCoursesQuerySchema, CreateCourseResponseSchema, UpdateCourseRequestSchema
...
def get_course_client(user: AuthenticationUserSchema) -> CoursesClient:
    """
